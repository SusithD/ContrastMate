/**
 * Icons for the Accessibility Auditor UI
...
export function IconX({ size = 16, className = '' }: IconProps): JSX.Element {
    return (
        <svg
            width={size}
            height={size}
...
export function IconAlertTriangle({ size = 16, className = '' }: IconProps): JSX.Element {
    return (
        <svg
            width={size}
            height={size}
...
export function IconEye({ size = 16, className = '' }: IconProps): JSX.Element {
    return (
        <svg
            width={size}
            height={size}
...
export function IconFilter({ size = 16, className = '' }: IconProps): JSX.Element {
    return (
        <svg
            width={size}
            height={size}
...
export function IconLayers({ size = 16, className = '' }: IconProps): JSX.Element {
    return (
        <svg
            width={size}
            height={size}
...
export function IconZoomIn({ size = 16, className = '' }: IconProps): JSX.Element {
    return (
        <svg
            width={size}
            height={size}
...
export function IconAccessibility({ size = 16, className = '' }: IconProps): JSX.Element {
    return (
        <svg
            width={size}
            height={size}
...
export function IconFontMissing({ size = 16, className = '' }: IconProps): JSX.Element {
    return (
        <svg
            width={size}
            height={size}
